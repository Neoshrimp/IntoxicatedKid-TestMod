...
namespace test
{
    public sealed class AlchemizeDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(Alchemize);
        }
    ...
    [EntityLogic(typeof(AlchemizeDef))]
    public sealed class Alchemize : Card
    {
        protected override IEnumerable<BattleAction> Actions(UnitSelector selector, ManaGroup consumingMana, Interaction precondition)
        {
            this.toolCards = base.GameRun.RollCards(base.GameRun.AdventureRng, new CardWeightTable(RarityWeightTable.EliteCard, OwnerWeightTable.Valid, CardTypeWeightTable.OnlyTool), 1, false, null);
